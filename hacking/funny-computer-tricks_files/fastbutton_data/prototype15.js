...
// NOTE: there are a few custom extensions in this file that were added
//       by hubpages (compare to prototype-original15.js)
...
Object.extend(Prototype.Hash.prototype, {
  _each: function(iterator) {
    for (var key in this) {
      var value = this[key];
      if (value && value == Prototype.Hash.prototype[key]) continue;
...
function $H(object) {
  if (object && object.constructor == Prototype.Hash) return object;
  return new Prototype.Hash(object);
};
...
Ajax.Request.prototype = Object.extend(new Ajax.Base(), {
  ...
  request: function(url) {
    ...
    params = Prototype.Hash.toQueryString(params);
...
var Form = {
  ...
  serializeElements: function(elements, getHash) {
    ...
    return getHash ? data : Prototype.Hash.toQueryString(data);
  },
...
Object.extend(Event, {
  ...
  _observeAndCache: function(element, name, observer, useCapture) {
	...
	if ( element==null) { return; } // suppress error below when element is null
